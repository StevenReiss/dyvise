...
/* SVN: $Id: DyperXmlWriter.java,v 1.1 2016/11/02 18:59:20 spr Exp $ */
...
class DyperXmlWriter extends PrintWriter
{
...
void textElement(String elt,String t)
{
   begin(elt);
   if (t != null) text(t);
   end();
