...
/********************************************************************************/
/*										*/
/*		dymonprocesslock.php						*/
/*										*/
/*	Output the lock analysis for a particular process			*/
/*										*/
/********************************************************************************/
...
<?php
echo "<body onload='loadLockTables(\"$pid\")'>\n";
echo "<h1 align='center' class='style1'>DYPER Locking for $pid</h1>\n";
?>
