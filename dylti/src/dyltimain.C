...
/*		dyltimain.C							*/
/*										*/
/*	Main entry and controller for JVMTI monitoring for lock monitoring	*/
/*										*/
/********************************************************************************/
...
/* RCS: $Header: /pro/spr_cvs/pro/dyvise/dylti/src/dyltimain.C,v 1.1 2011-09-12 18:29:46 spr Exp $ */
...
static DyltiMain	dylti_main = NULL;
...
Agent_OnLoad(JavaVM * jvm,char * opts,void *)
{
   ...
   dylti_main = new DyltiMainInfo(jvm,jvmti,opts);
   dylti_main->initialSetup();
...
DyltiMainInfo::DyltiMainInfo(JavaVM * jvm,DyltiEnv env,const char * opts)
{
   java_vm = jvm;
   jvmti_env = env;
   ...
   using_monitor = new DyltiMonitorInfo(this,java_vm,jvmti_env);

   // cerr << "DYLTI: Loaded" << endl;
}



DyltiMainInfo::~DyltiMainInfo()
{
...
void
DyltiMainInfo::finalize()
{
   using_monitor->outputXml();
}
...
CStdString
DyltiMainInfo::getOption(CStdString c)		       { return user_options[c]; }
